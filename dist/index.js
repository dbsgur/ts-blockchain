...
const genesisBlock = new Block(0, "20202002020202020", "", "Hello", 123456);
...
const getHashforBlock = (aBlock) => Block.calculateBlockHash(aBlock.index, aBlock.previosHash, aBlock.timestamp, aBlock.data);
